      ...
      >
        <View className="items-center p-2 gap-3">
          <View className="w-12 h-12 border border-foreground items-center justify-center bg-surface shadow-[2px_2px_0px_var(--color-foreground)]">
            <Ionicons name="information" size={24} color={colors.foreground} />
          </View>

          <View className="items-center">
            <MachineText variant="header" size="lg" className="mb-1">
              SYSTEM_NOTICE
            </MachineText>
            <MachineText className="text-center text-xs text-muted max-w-50">
