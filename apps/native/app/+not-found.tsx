  ...
  return (
    <>
      ...
      <Container className="bg-background flex-1 justify-center items-center">
        <HardCard label="ERR_404" variant="default" className="w-[80%] max-w-sm bg-surface p-6 items-center">
          ...
          <Link href="/" asChild>
            <Button size="lg" className="rounded-none bg-foreground shadow-[2px_2px_0px_var(--color-accent)]">
