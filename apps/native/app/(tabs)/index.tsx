...
export default function Today() {
  ...
  return (
    <Container className="pt-8">
      ...
      <HardCard className="mb-8" padding="sm" label="QUICK LOG">
        <View className="gap-3 p-2">
          <Button
            size="sm"
            className="self-start bg-surface border border-foreground rounded-none"
            onPress={() => setShowQuickLog((value) => !value)}
          >
            <MachineText className="text-xs font-bold text-foreground">
              {showQuickLog ? "HIDE INPUTS" : "OPEN INPUTS"}
            </MachineText>
          </Button>
      ...
      <HardCard className="mb-8" padding="sm" label="INSIGHTS">
        <View className="gap-3 p-2">
          <Button
            size="sm"
            className="self-start bg-surface border border-foreground rounded-none"
          ...
          {showInsights ? (
            <View className="gap-6">
              ...
              {weeklyReview ? (
                <HardCard label="AI_NARRATIVE" className="bg-surface">
              ...
              {data?.state?.mode === "recovery" ? (
                <HardCard label="RECOVERY_PROTOCOL" className="bg-surface">
                  <View className="p-2 gap-3">
                    <MachineText variant="label" className="text-accent">
